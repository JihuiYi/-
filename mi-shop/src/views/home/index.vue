  ...
  export default {
    ...
    mounted() {
      ...
      setTimeout(()=>{
        ...
        this.$refs.view08.scrollTop = DB.getItemOnce('home-index-view08').toNumber() || 0
        this.$refs.view09.scrollTop = DB.getItemOnce('home-index-view09').toNumber() || 0
      }, 10)
    ...
    beforeRouteLeave (to, from, next) {
      ...
      DB.setItem('home-index-view08', this.$refs.view08.scrollTop)
      DB.setItem('home-index-view09', this.$refs.view09.scrollTop)
